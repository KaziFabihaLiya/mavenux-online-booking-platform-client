    ...
    <div className="bg-stone-50 min-h-screen">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-black/60 to-black/40 flex items-center justify-center">
              <div className="text-center text-white px-4 max-w-4xl">
                ...
                <p className="text-lg md:text-2xl text-stone-100">{slide.subtitle}</p>
              </div>
            </div>
          </div>
        ))}
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-stone-600 text-lg">Handpicked deals just for you</p>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600 text-lg">Recently added travel options</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-stone-600 text-lg">Your trusted travel companion</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-stone-100">
            ...
            <h3 className="text-xl font-bold text-stone-800 mb-3">Best Prices</h3>
            <p className="text-stone-600 leading-relaxed">Compare prices and get the best deals on your travel</p>
          </div>
          ...
          <div className="text-center p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-stone-100">
            ...
            <h3 className="text-xl font-bold text-stone-800 mb-3">24/7 Support</h3>
            <p className="text-stone-600 leading-relaxed">Our team is always here to help you with any issues</p>
          </div>
          ...
          <div className="text-center p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-stone-100">
            ...
            <h3 className="text-xl font-bold text-stone-800 mb-3">Wide Network</h3>
            <p className="text-stone-600 leading-relaxed">Travel to hundreds of destinations across the country</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-amber-500 via-amber-600 to-orange-600 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 text-white">
            ...
            <p className="text-amber-50 text-lg">Most traveled destinations</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Dhaka → Chittagong', 'Dhaka → Sylhet', "Dhaka → Cox's Bazar", 'Dhaka → Khulna',
              'Dhaka → Rajshahi', 'Dhaka → Rangpur', 'Dhaka → Barisal', "Chittagong → Cox's Bazar"].map((route, idx) => (
              <div 
                key={idx} 
